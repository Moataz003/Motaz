...
if (isset($_GET['token'])) {
    ...
    if ($user) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $new_password = md5($_POST['password']);  // Use md5 to hash the new password

            // Update the password in the database (with md5 hashing)
...
<!-- Navbar End -->
    ...
    <main>
        ...
        <div class="form-group">
            <label for="new_password" class="from-label">New Password:</label>
            <input type="password" class="form-input" id="new_password" name="new_password" required>
            <button type="button" class="toggle-password" id="toggleNewPassword">👁️</button>
